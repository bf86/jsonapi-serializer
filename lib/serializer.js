...
var includeParser = require('./include-parser');
var _mapValues = require('lodash/mapValues');
var SerializerUtils = require('./serializer-utils');
var _ = require('lodash');

module.exports = function(collectionName, records, opts) {
  this.serialize = function(records, req, res) {
    var that = this;
    var payload = {};

    if (req) {
      let optsClone = _.cloneDeep(that.originalOpts);
      var parsedOpts = includeParser(optsClone, req, res)
      parsedOpts = fieldsParser(that.collectionName, parsedOpts, req);
    }
